...
# python train.py
CUDA_VISIBLE_DEVICES=0,1 python3 train.py --curriculum CARLA --output_dir /checkpoint/${USER}/${SLURM_JOB_ID}/DELAYEDPURGE --n_epochs 3000 --sample_interval 1000 --model_save_interval 5000
